...
- Multiple solver implementations:
  - DFS Exhaustive Solver [🐍 implementation](src/solvers/dfs_exhaustive_solver.py)
  - Genetic Algorithm Solver [🐍 implementation](src/solvers/genetic_algorithm_solver.py)
  - Optimized Genetic Solver [🐍 implementation](src/solvers/optimized_genetic_solver.py)
  - Hill Climbing Solver [🐍 implementation](src/solvers/greedy_hill_climbing_solver.py)
  - Optimized Hill Climbing Solver [🐍 implementation](src/solvers/greedy_hill_climbing_solver.py)
  - Simulated Annealing Solver [🐍 implementation](src/solvers/simulated_annealing_solver.py)
  - Novel Mutation Genetic Solver [🐍 implementation](src/solvers/novel_mutation_genetic_solver.py)
...
- **Novel Mutation Genetic Solver**: Introduces novel mutation strategies to improve solution diversity.
